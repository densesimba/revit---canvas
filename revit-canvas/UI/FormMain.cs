       ...
       public List<List<Point>> roomPolygons = new List<List<Point>>();
        ...
        private void picCanvas_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (NewPolygon != null)
            {
                ...
                {
                    // Finish this polygon.
                    if (NewPolygon.Count > 2) roomPolygons.Add(NewPolygon);
                    NewPolygon = null;
        ...
        private void picCanvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            foreach (List<Point> polygon in roomPolygons)
            {
                ...
                {
                    var lastRoom = rooms.Values.LastOrDefault();
        ...
        private bool MouseIsOverEdge(Point mouse_pt, out List<Point> hit_polygon, out int hit_pt1, out int hit_pt2, out Point closest_point)
        {
            ...
            for (int pgon = roomPolygons.Count - 1; pgon >= 0; pgon--)
            {
                List<Point> polygon = roomPolygons[pgon];
